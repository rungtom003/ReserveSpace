...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    if ($connect_status == "success") {
        $sql = "SELECT a.r_Id,a.r_Note,a.r_Status,a.r_DateTime,b.a_Id,b.a_Name,b.a_ReserveStatus,c.z_Name,d.u_FirstName,d.u_LastName,d.u_CardNumber,d.u_Phone,d.u_Prefix,d.u_Birthday,d.u_Address,d.u_Road,d.u_SubDistrict,d.u_District,d.u_Province,d.u_ShopName,d.u_ProductName FROM kkmuni_street.tb_reserve as a  INNER JOIN kkmuni_street.tb_area as b ON a.a_Id = b.a_Id INNER JOIN kkmuni_street.tb_zone as c ON b.z_Id = c.z_Id INNER JOIN kkmuni_street.tb_user as d ON d.u_Id = a.u_Id ;";
